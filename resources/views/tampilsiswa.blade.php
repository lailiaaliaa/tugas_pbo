                        ...
                        <form action="/update/{{ $data->id }}" method="POST" enctype="multipart/form-data">
                                                <br>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number"  name="nisn" class="form-control" id="" value="{{ $data->nisn }}" placeholder="">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="exampleInputCity1">Nis</label>
                                                        <input type="number"  name="nis"  class="form-control" value="{{ $data->nis }}" id="exampleInputCity1" placeholder="">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="exampleInputCity1">Nama</label>
                                                        <input type="text"  name="nama"  class="form-control" value="{{ $data->nama }}"id="exampleInputCity1" placeholder="">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="exampleTextarea1">Kelas</label>
                                                        <input type="text" name="kelas"  class="form-control" value="{{ $data->kelas }}"id="exampleTextarea1" >
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="exampleInputCity1">Alamat</label>
                                                        <input type="text"  name="alamat"  class="form-control" value="{{ $data->alamat }}" id="exampleInputCity1" placeholder="">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="exampleInputCity1">Telepon</label>
                                                        <input type="number"  name="telp"  class="form-control" value="{{ $data->telp }}"id="exampleInputCity1" placeholder="">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="exampleInputCity1">Spp</label>
                                                        <input type="number"  name="spp"  class="form-control" value="{{ $data->spp }}"id="exampleInputCity1" placeholder="">
                                                    </div><br>
                                                    <button type="submit" class="btn btn-primary">Simpan</button>
                                                 <button class="btn btn-outline-primary" href="/siswa">Cancel</button>
                                              </form>
                                            </div>
                                          </div>
                                        </div>
