    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            ...
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                    <h2 class="text-center text-primary">Ubah Nilai</h2>

<form action="/updaten/{{ $data->id }}" method="POST" enctype="multipart/form-data">
                    <br>
                        @csrf
                        <div class="form-group">
                            <label for="exampleInputName1">Normatif</label>
                            <input type="number"  name="nor" class="form-control" id="" value="{{ $data->nor }}" placeholder="">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputCity1">Adaptif</label>
                            <input type="number"  name="ada"  class="form-control" value="{{ $data->ada }}" id="exampleInputCity1" placeholder="">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputCity1">Produktif</label>
                            <input type="number"  name="pro"  class="form-control" value="{{ $data->pro }}"id="exampleInputCity1" placeholder="">
                        </div>
                       <br>
                        <button type="submit" class="btn btn-primary">Simpan</button>
                     <button class="btn btn-outline-primary" href="/nilai">Cancel</button>
                  </form>
                </div>
              </div>
            </div>
