                  ...
                  <form action="/insert" method="POST" enctype="multipart/form-data">
                    <br>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number"  name="nisn" class="form-control" id="" placeholder="">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputCity1">Nis</label>
                            <input type="number"  name="nis"  class="form-control" id="exampleInputCity1" placeholder="">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputCity1">Nama</label>
                            <input type="text"  name="nama"  class="form-control" id="exampleInputCity1" placeholder="">
                        </div>
                        <div class="form-group">
                            <label for="exampleTextarea1">Kelas</label>
                            <input type="text" name="kelas"  class="form-control" id="exampleTextarea1" >
                        </div>
                        <div class="form-group">
                            <label for="exampleInputCity1">Alamat</label>
                            <input type="text"  name="alamat"  class="form-control" id="exampleInputCity1" placeholder="">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputCity1">Telepon</label>
                            <input type="number"  name="telp"  class="form-control" id="exampleInputCity1" placeholder="">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputCity1">Spp</label>
                            <input type="number"  name="spp"  class="form-control" id="exampleInputCity1" placeholder="">
                        </div><br>
